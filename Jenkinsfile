...
pipeline{
    ...
    stages{
        ...
        stage('Docker Image scan :trivy'){
            ...
            steps{
                script{
                    DockerImageScan("${params.ImageName}","${params.ImageTag}","${params.Hubuser}")
                }
            }
        }
        stage('Docker Image push :DockerHub'){
            ...
            steps{
                script{
                    DockerPush("${params.ImageName}","${params.ImageTag}","${params.Hubuser}")
                }
            }
        }
        stage('Docker Image Cleanup'){
            ...
            steps{
                script{
                    ...
                    DockerImageCleanup("${params.ImageName}","${params.ImageTag}","${params.Hubuser}")
                }
            }
        }
